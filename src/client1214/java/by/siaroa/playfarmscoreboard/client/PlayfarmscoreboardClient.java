...
public class PlayfarmscoreboardClient implements ClientModInitializer {
    ...
    private void onClientTick(MinecraftClient client) {
        ...
        boolean jDown = InputUtil.isKeyPressed(client.getWindow().getHandle(), InputUtil.GLFW_KEY_J);
        boolean kDown = InputUtil.isKeyPressed(client.getWindow().getHandle(), InputUtil.GLFW_KEY_K);
